package com.example.demo.srping.version;
...
public class ApiVesrsionCondition implements RequestCondition<ApiVesrsionCondition> {
  ...
  public ApiVesrsionCondition getMatchingCondition(HttpServletRequest request) {
    ...
    String versionStr = request.getHeader("ApiVersion");
    if (null == versionStr  && this.apiVersion == 0) {
      return this;
    }
  ...
  @Override
  public int compareTo(ApiVesrsionCondition apiVesrsionCondition,
